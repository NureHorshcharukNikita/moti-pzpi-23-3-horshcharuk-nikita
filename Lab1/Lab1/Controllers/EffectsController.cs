...
namespace Lab1.Controllers
{
    ...
    public class EffectsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("EffectID,EffectCode,EffectName,EffectDescription")] Effect effect)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("EffectID,EffectCode,EffectName,EffectDescription")] Effect effect)
        {
