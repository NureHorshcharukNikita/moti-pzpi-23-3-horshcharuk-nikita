...
CREATE TABLE IF NOT EXISTS Effects (
  ...
  Etalon            REAL    NOT NULL DEFAULT 1,
  Type              TEXT    NOT NULL DEFAULT 'MAX' CHECK (Type IN ('MAX','MIN'))
);
...
INSERT OR IGNORE INTO Effects (EffectCode, EffectName, EffectDescription, Etalon, Type) VALUES
('DAMAGE',  'Damage',    'Amount of damage dealt', 10, 'MAX'),
('HEAL',    'Healing',   'Health restored',        10, 'MAX'),
('BLOCK',   'Block',     'Damage prevented',       10, 'MAX'),
('UTILITY', 'Utility',   'General usefulness',     10, 'MAX'),
('CONTROL', 'Control',   'Crowd control',          10, 'MAX'),
('COST',    'Mana Cost', 'Mana required',           1, 'MIN');
